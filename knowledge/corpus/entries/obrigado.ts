 ...
 */
export const obrigado: KnowledgeCorpusEntry = {
  id: 'obrigado',
  ...
  linguisticParameters: {
    handConfiguration: 'Mão aberta com dedos unidos',
    location: 'Próxima ao rosto',
    movement: 'Deslocamento para frente e levemente para baixo',
    orientation: 'Palma com orientação descendente durante o movimento',
    nonManualExpression: 'Expressão de agradecimento',
  },
  context: 'Agradecimento em interações formais e informais',
