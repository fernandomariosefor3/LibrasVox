 ...
 */
export const ola: KnowledgeCorpusEntry = {
  id: 'ola',
  portugueseWord: 'Olá',
  gloss: 'OLÁ',
  category: 'Básico',
  ...
  linguisticParameters: {
    handConfiguration: 'Mão aberta, dedos estendidos e separados',
    location: 'Altura do rosto, ao lado da cabeça',
    movement: 'Movimento lateral curto e repetido',
    orientation: 'Palma voltada para a pessoa interlocutora',
    nonManualExpression: 'Expressão facial amistosa e contato visual',
  },
  context: 'Saudação informal e início de interação',
