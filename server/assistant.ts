...
import { ASSISTANT_MODE_IDS } from '../api/_lib/contracts.js';
import { classifyRequest } from '../api/_lib/requestClassifier.js';
import type { TutorKnowledgeProvider } from '../api/_lib/tutorKnowledgeProvider.js';
import { defaultTutorKnowledgeProvider } from '../api/_lib/inProcessTutorKnowledgeProvider.js';
import { buildGroundedPrompt } from '../api/_lib/groundedPromptBuilder.js';
import { validateTutorResponse } from '../api/_lib/tutorResponseValidator.js';
import { createRateLimiter } from '../api/_lib/rateLimit.js';
import {
...
export function createAssistantHandler(provider: TutorKnowledgeProvider = defaultTutorKnowledgeProvider) {
  ...
  async function handleLinguistic(question: string, corpusVersion: string): Promise<HandlerResult> {
    ...
    try {
      ...
      const { generateGroundedAnswer } = await import('../api/_lib/geminiProvider.js');
